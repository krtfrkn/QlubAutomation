...
def test_rate():
    #Select Rate
    driver.find_element(By.ID, "css-ykqdxu").click()
    sleep(3)
...
def test_email():
    ...
    sleep(2)
    #Click On Send
    driver.find_element('//*[@id="__next"]/div[2]/div/form/div/div[3]/button').click()
    sleep(8)


def test_dl_recipet():
    #Click On Download For Bill 
    driver.find_element('//*[@id="__next"]/div[2]/div/form/div/div[4]/a').click()
    sleep(10)
