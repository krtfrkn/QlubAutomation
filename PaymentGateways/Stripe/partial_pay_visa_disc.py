...
def test_qr():
    ...
    location = ('https://app-staging.qlub.cloud/qr/ae/SezaiStripeDiscount/5/_/_/dae6bb8adc')
    driver.get(location)
    sleep(10)
    ...
    driver.find_element(By.XPATH,
                        '//*[@id="__next"]/div[2]/div/div/div/div[2]/div[1]/div[2]/main/div/div/div[2]/div/div[2]/div[2]/button[1]').click()
    sleep(3)
