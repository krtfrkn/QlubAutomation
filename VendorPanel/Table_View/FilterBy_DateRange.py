...
def test_login():
    ...
    sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[4]/div[4]').click()
    sleep(4)

    driver.find_element(By.XPATH,'/html/body/div[3]/div[3]/div/div[2]/div/div/div/div[7]').click()
    sleep(3)
    driver.find_element(By.XPATH,'/html/body/div[3]/div[3]/div/div[2]/div/div/div/div[8]').click()
    sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[4]/div[3]/div/div[1]/p/div/div/div/div/div[2]/div/div[2]/div/div[2]/div[3]').click()
    sleep(4)
    driver.find_element(By.XPATH,'/html/body/div[4]/div[3]/div/div[1]/div').click()
    sleep(4)
    driver.find_element(By.XPATH,'/html/body/div[4]/div[3]/div/div[2]/button[2]').click()
    sleep(3)
