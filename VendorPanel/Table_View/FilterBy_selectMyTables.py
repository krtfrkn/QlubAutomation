...
def test_login():
    ...
    driver.find_element(By.XPATH,
                        '//*[@id="__next"]/div/div[2]/div[2]/div/div/div/div[2]/div/div/form/div/div[1]/div/div/div').click()
    sleep(4)
    ...
    sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[4]/div[3]').click()
    sleep(4)

    driver.find_element(By.XPATH,'/html/body/div[3]/div[3]/div/div[2]/div/div/div[1]').click()
    sleep(3)
