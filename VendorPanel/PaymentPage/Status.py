...
def test_login():
    ...
    driver.find_element(By.XPATH,'//*[@id="__next"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[2]').click()
    sleep(3)
    driver.find_element(By.XPATH,'//*[@id="paid"]').click()
    sleep(4)

    driver.find_element(By.XPATH, '//*[@id="__next"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[2]').click()
    sleep(3)
    driver.find_element(By.XPATH, '//*[@id="partially"]').click()
    sleep(4)

    driver.find_element(By.XPATH, '//*[@id="__next"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[2]').click()
    sleep(3)
    driver.find_element(By.XPATH, '//*[@id="refunded"]').click()
    sleep(4)
