...
def test_login():
    ...
    driver.find_element(By.XPATH,'//*[@id="__next"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[4]').click()
    sleep(3)
    driver.find_element(By.ID,'created_asc').click()
    sleep(4)

    driver.find_element(By.XPATH,'//*[@id="__next"]/div/div[2]/div[2]/div[2]/div[1]/div[2]/div/div[4]').click()
    sleep(3)
    driver.find_element(By.ID,'created_desc')
    sleep(4)
