...
def test_qr():
    ...
    #Add restaurant link
    location = ('https://app-staging.qlub.cloud/qr/ae/dummy/73/1/_/a5cf5482b0')
    driver.get(location)
    sleep(10)
...
def test_fetch_order(): 
    ...
    #Enter Card Number wrong
def test_stripe_wrong_card():
    ...
    driver.find_element(By.NAME, "number").send_keys("4242424242424241")
