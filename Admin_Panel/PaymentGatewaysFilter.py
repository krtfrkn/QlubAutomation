...
def test_login():
    ...
    driver.find_element(By.XPATH,'//*[@id="search-field"]').send_keys('stripe')
    sleep(4)

    driver.find_element(By.ID, 'payment-gateways-action-btn-0').click()
    sleep(4)

    driver.find_element(By.ID, 'payment-gateways-action-activity_logs').click()
    sleep(4)
