...
def test_login():
    ...
    driver.find_element(By.ID,'countries-menu-item').click()
    sleep(3)

    driver.find_element(By.XPATH,'//*[@id="search-field"]').send_keys('tanzania')
    sleep(4)

    driver.find_element(By.ID,'countries-action-btn-0').click()
    sleep(4)

    driver.find_element(By.ID,'countries-action-activity_logs').click()
    sleep(4)
