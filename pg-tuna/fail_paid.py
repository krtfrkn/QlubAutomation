...
def test_tuna():
    ...
    sleep(6)
    driver.find_element(By.NAME, "cardNumber_creditCard").send_keys("4111111111111112")
    sleep(5)
    ...
    #Enter card correct
def test_tuna_true():
    driver.find_element(By.NAME, "cardNumber_creditCard").send_keys(Keys.BACKSPACE)
    driver.find_element(By.NAME, "cardNumber_creditCard").send_keys("1")
