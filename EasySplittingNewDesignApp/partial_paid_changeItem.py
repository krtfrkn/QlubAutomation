...
def test_qr():
    ...
    # Add restaurant link
    location = ('https://app-staging.qlub.cloud/qr/ae/dummyStripeSezai/63/_/_/5fafc564b5')
    driver.get(location)
    sleep(10)
    ...
    # Pay for your items
    driver.find_element(By.ID, 'select-byItem').click()
    sleep(7)
    ...
    sleep(3)
    driver.find_element(By.ID, 'remove-item-1').click()
    sleep(3)
