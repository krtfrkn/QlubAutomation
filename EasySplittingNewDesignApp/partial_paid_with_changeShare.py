...
def test_qr():
    ...
    # Add restaurant link
    location = ('https://app-staging.qlub.cloud/qr/ae/dummyStripeSezai/64/_/_/70d099a2b4')
    driver.get(location)
    sleep(10)
    ...
    driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div[2]/div/div[1]/div/div[1]/div[3]/div/div/button[2]').click()
    sleep(3)
    driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div[2]/div/div[1]/div/div[2]/div[3]/div/div/button[2]').click()
    sleep(3)
